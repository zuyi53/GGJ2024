...
class ADVANCEDRPGSYSTEM_API UARSStatisticsComponent : public UActorComponent {
  ...
  public:
    ...
    /*Returns the amount of totale experience necessary for level up*/
    UFUNCTION(BlueprintPure, Category = ARS)
   ...
   /*Returns the total exps required to reach the provided level from level 0*/
    ...
    /*Returns Current total exps - Exps from previous level, useful for UI*/
    UFUNCTION(BlueprintPure, Category = ARS)
    int32 GetCurrentExptsFromPreviousLevel() const;
